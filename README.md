...
python bench_build.py                         # freeze bench_hard.json
python bench_driver.py                        # hard-bench battery, 6 seeds (hours)
python bench_analysis.py                      # stats over committed runs
python strict_final.py                        # re-score committed evals
```

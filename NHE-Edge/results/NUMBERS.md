...
(24 layers, hidden 896, ChatML prompts, fp16). Full report: `cross_arch_report.md` Sec 7.
...
- **No multiple-comparison correction** is applied across the ~10 reported McNemars
  (masks x windows x arms x benches). Random-bench p=0.031 would not survive one.
